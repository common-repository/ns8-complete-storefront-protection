=== NS8 Protect™ ===
Tags: ecommerce, e-commerce, store, fraud, fraud protection, ad fraud, order fraud, performance monitoring, payment fraud, storefront, woocommerce
...
== Description ==
NS8 Protect for WooCommerce and WordPress is a comprehensive fraud prevention platform that combines behavioral analytics, real-time scoring, and global monitoring to help merchants of all sizes optimize order processing and minimize risk. Built on the Protect API, this app integrates directly into NS8's platform and allows merchants to begin fighting fraud within minutes.
...
NS8 is a pay-as-you-go service with flexible pricing based on the number of scores received per month. This number is calculated as the total amount of page views you receive on your website, plus the quantity of orders analyzed by NS8. A separate NS8 account is required and will be created automatically when you install NS8. After the 30-day free trial period, pricing begins at $29.95 per month. A credit card is required for monthly billing. For more pricing information, visit https://www.ns8.com/pricing.

_*Scores are defined as the total number of page views plus the total number of orders analyzed._

== Frequently Asked Questions ==

= Can NS8 Protect work without WooCommerce? =

NS8 Protect’s advertising, fraud, and performance monitoring capabilities will continue to work even without an active storefront.

= Where is the best place to get support? =

NS8 live chat and email ticket support for all users. You can get help at [NS8 Support](support@ns8.com).

= Will NS8 Protect work with my theme? =

Yes; NS8 Protect does not affect the frontend of your website. All of NS8 Protect’s features are accessible only through the WordPress admin and WooCommerce order pages.
